			...
			<div class="content" slot="content">
				...
				<div class="table-content">
					...
					<el-table :data="detail" height="442" border style="width:100%">
						...
						<el-table-column prop="payment" label="采购金额" min-width="120" inline-template>
	...
	export default {
		data() {
			var crumbs = [
				...
				{path: '/reports/purReports/purchaseListDetail', name: '采购详情'},
			];
			return {
				crumbs,
				formSearch: {
		...
		methods: {
            ...
            handleExport(){
                utils.export('/pms/report/purchase/detail/export.do',{"purchaserId":this.$route.query.id,"startTime":this.formSearch.date.length >0 && this.formSearch.date[0]?moment(this.formSearch.date[0]).format('YYYY-MM-DD'):'',"endTime":this.formSearch.date.length >1 && this.formSearch.date[1]?moment(this.formSearch.date[1]).format('YYYY-MM-DD'):''})
            }
		},
		created(){
			this.refresh()

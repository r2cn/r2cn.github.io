			...
			<div class="content" slot="content">
				<div class="search-bar">
					<el-form :inline="true" :model="formSearch" class="form-search">
						<el-form-item>
							<el-select placeholder="结算对象" v-model="settlementReceiver" @change="onSubmit" clearable>
				...
				<div class="table-content">
					...
					<el-table v-loading="loading" element-loading-text="玩命加载中" :data="list" height="442" border style="width:100%">
						...
						<el-table-column prop="cashierName" label="收款人姓名" min-width="100"></el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
            ...
            handleExport(){
                utils.export('/pms/report/settlement/export.do',{"filter":"","startTime":this.formSearch.date.length >0 && this.formSearch.date[0]?moment(this.formSearch.date[0]).format('YYYY-MM-DD'):'',"endTime":this.formSearch.date.length >1 && this.formSearch.date[1]?moment(this.formSearch.date[1]).format('YYYY-MM-DD'):''})
            }
		},
		created(){
			this.refresh()

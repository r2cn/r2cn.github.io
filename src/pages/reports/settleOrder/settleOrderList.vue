            ...
            <div class="content" slot="content">
                ...
                <div class="table-content">
                    <div class="button-bar">
                        ...
                        <el-row>
                            <el-col :span="24">结算总额：<span class="orange">&yen;{{totalAmount|number}}</span></el-col>
                        </el-row>
                    </div>
                    <el-table v-loading="loading" element-loading-text="玩命加载中" :data="list" height="442" border style="width:100%">
                        ...
                        <el-table-column prop="receivedAmount" label="结算金额" min-width="100" inline-template>
                            <span>{{row.receivedAmount|number}}</span>
                        </el-table-column>
                        <el-table-column label="结算时间" min-width="120" inline-template>
                            <span>{{row.settlementTime | moment}}</span>
                        </el-table-column>
                        <el-table-column prop="settlementUserName" label="结算人" min-width="100"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleExport(){
                utils.export('/pms/report/settle/order/export.do',{"filter":this.formSearch.purchaseno,"startTime":this.formSearch.date.length >0 && this.formSearch.date[0]?moment(this.formSearch.date[0]).format('YYYY-MM-DD'):'',"endTime":this.formSearch.date.length >1 && this.formSearch.date[1]?moment(this.formSearch.date[1]).format('YYYY-MM-DD'):''})
            }
        },
        created(){
            this.refresh()

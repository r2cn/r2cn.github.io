		...
		<div class="content" slot="content">
			<div class="search-bar">
				<el-form :inline="true" class="demo-form-inline">
					<el-form-item>
						<el-input v-model="filter" placeholder="请输入单位名称/简拼"></el-input>
					</el-form-item>
					<el-form-item>
			...
			<div class="table-content">
				<div class="button-bar">
					<el-button type="orange" @click="addMateriel">新增单位</el-button>
				...
				@selection-change="handleSelectionChange">
					...
					<el-table-column prop="materialUnitName" label="单位名称" min-width="100"></el-table-column>
					<el-table-column prop="materialUnitShortName" label="单位简拼" min-width="60"></el-table-column>
					<el-table-column inline-template :context="_self" label="操作" min-width="110">
					  <span>
						<el-button type="primary" size="small" @click="materielInfo(row.materialUnitId)">修改</el-button>
						<el-button type="primary" size="small" @click="deleteMaterial(row.materialUnitId)">删除</el-button>
					  </span>
					</el-table-column>
				</el-table>
...
<script type="text/javascript">
	...
	export default {
		...
		methods:{
            ...
            /*删除单位*/
            deleteMaterial(materialUnitId){
                let that = this;
				let requestData = [materialUnitId];
                this.$confirm('确认删除吗？', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
